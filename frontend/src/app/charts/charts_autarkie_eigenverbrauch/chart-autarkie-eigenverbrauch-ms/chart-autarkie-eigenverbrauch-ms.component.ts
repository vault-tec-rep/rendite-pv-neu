...
@Component({
  selector: 'app-chart-autarkie-eigenverbrauch-ms',
  templateUrl: './chart-autarkie-eigenverbrauch-ms.component.html',
  styleUrls: ['./chart-autarkie-eigenverbrauch-ms.component.css']
})
export class ChartAutarkieEigenverbrauchMsComponent implements OnInit {
  chartInstance;
