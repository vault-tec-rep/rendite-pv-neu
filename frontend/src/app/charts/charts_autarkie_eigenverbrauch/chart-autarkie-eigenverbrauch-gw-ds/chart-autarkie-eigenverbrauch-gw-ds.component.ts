...
@Component({
  selector: 'app-chart-autarkie-eigenverbrauch-gw-ds',
  templateUrl: './chart-autarkie-eigenverbrauch-gw-ds.component.html',
  styleUrls: ['./chart-autarkie-eigenverbrauch-gw-ds.component.css']
})
export class ChartAutarkieEigenverbrauchGwDsComponent implements OnInit {
  chartInstance;
