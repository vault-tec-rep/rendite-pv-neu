...
@Component({
  selector: 'app-chart-autarkie-eigenverbrauch-ev',
  templateUrl: './chart-autarkie-eigenverbrauch-ev.component.html',
  styleUrls: ['./chart-autarkie-eigenverbrauch-ev.component.css']
})
export class ChartAutarkieEigenverbrauchEvComponent implements OnInit {
  chartInstance;
